    ...
    <main className="min-h-screen bg-gray-950 text-white p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
          ...
          <input
            type="text"
            placeholder="URL del sitio web (ej: https://negocio.com)"
            value={url}
        ...
        {(datos || infra) && (
          <>
                ...
                <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-gray-400 text-sm">{datos.negocio?.total_resenas} reseñas</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className={`rounded-xl p-5 border ${infra.velocidad?.alerta ? 'bg-red-950 border-red-500' : 'bg-gray-900 border-gray-800'}`}>
                    ...
                    {infra.velocidad ? (
                      ...
                      <p className="text-gray-500 text-sm">Ingresa la URL del sitio para analizar velocidad</p>
                    )}
                  </div>
                </div>
              </div>
            ...
            {tab === 'reputacion' && datos && !filtrarPorFecha(datos) && (
              <p className="text-gray-400 text-center py-10">No hay datos para la fecha seleccionada.</p>
            )}
